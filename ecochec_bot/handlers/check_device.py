...
from ecochec_bot import texts
from ecochec_bot.kbs.kb_to_choose_device import d_get_kb, DeviceCallbackFactory
from ecochec_bot.kbs.main_kb import get_main_kb
from ecochec_bot.kbs.cancel import cancel_kb
from ecochec_bot.db_func import get_devices, get_data_from_device, get_user_city, check_user, get_addr, get_city_by_id
